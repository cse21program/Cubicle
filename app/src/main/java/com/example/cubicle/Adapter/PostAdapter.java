...
import com.example.cubicle.EventRegistrationActivity;
import com.example.cubicle.ImageViewerActivity;
import com.example.cubicle.LikeAndCommentActivity;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.PostViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final PostViewHolder holder, int position) {
...

        {
            ...
            holder.WhoRegister.setVisibility(View.VISIBLE);
            holder.WhoRegister.setText(event_name+" event registration is on going..");
            holder.WhoRegister.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
    ...
    public class PostViewHolder extends RecyclerView.ViewHolder{
        ...
        public PostViewHolder(@NonNull View itemView) {
            ...
            WhoRegister=itemView.findViewById(R.id.whoRegisteredEvent);
        }
    }
}
